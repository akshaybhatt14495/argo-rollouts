...
- File a ticket [here](https://github.com/akshaybhatt14495/argo-rollouts/issues) if you would like another implementation (or thumbs up it if that issue already exists)
